...
export type Article = { id:string; slug:string; category:string; titleJapanese:string; titleThai:string; target:string[]; readTime:string; language:string[]; summaryJapanese:string; contentJapanese:string; contentThai:string; tags:string[]; imageUrl:string };
...
export const FAN_ARTICLES = core.fanArticles as unknown as Article[];
export const LAB_ARTICLES = core.labArticles as unknown as Article[];
